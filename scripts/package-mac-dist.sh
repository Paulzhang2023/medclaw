...
ZIP="$ROOT_DIR/dist/MedClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/MedClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/MedClaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/MedClaw-$VERSION.dSYM.zip"
